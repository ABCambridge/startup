...
* Application elements: Used consistent styling to indicate certain types of fields or elements. They are easily distinguishable from each other and make sense visually.
* Application text content: Font is consistent throughout (default font). 
